    ...
    <div className="space-y-6">
      ...
      {step === "select" && (
        <>
          {/* AI 추천 사진 */}
          <div>
            <h2 className="text-xl font-semibold text-gray-800 mb-3">AI 추천 사진 (품질 점수 80+)</h2>
              ...
              <div className="grid grid-cols-2 gap-3">
                {recommendedPhotos.map((photo) => (
                  <button
                    ...
                    className="relative bg-white border border-gray-200 rounded-2xl overflow-hidden text-left"
                  >
                    ...
                    <div className="p-3">
                      <p className="text-sm font-semibold text-gray-900">{photo.tradeNameKo} · {PHASE_LABEL[photo.phase] ?? photo.phase}</p>
                      <p className="text-xs text-gray-500 truncate">{photo.siteName}</p>
                    </div>
                  </button>
                ))}
              </div>
          ...
          {posts.length > 0 && (
            <div>
              <h2 className="text-xl font-semibold text-gray-800 mb-3">게시물 관리</h2>
      ...
      {step === "edit" && selectedPhoto && (
        <div className="space-y-4">
          ...
          {/* 캡션 편집 */}
          <div>
            <label className="block text-base font-semibold text-gray-700 mb-2">캡션</label>
            <textarea
              value={caption}
